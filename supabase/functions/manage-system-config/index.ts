...
serve(async (req) => {
  ...
  try {
    ...
    console.log("manage-system-config authHeader", authHeader);

    // ============ DEVELOPMENT: Temporary bypass for testing ============
    // In production, uncomment the following authorization check
